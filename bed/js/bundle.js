...
!function (t, e) {
  ...
  return R.prototype = {
    ...
    if (e) if (e.length) for (var n, r = 0; n = e[r]; r += 1) {
      a(t, n);
    } else a(t, e);
...
/* harmony import */ var _blocks_popups_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %blocks%/popups/popups */ "./src/blocks/popups/popups.js");
/* harmony import */ var _blocks_popups_popups__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_blocks_popups_popups__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _blocks_pages_home_home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %blocks%/pages/home/home */ "./src/blocks/pages/home/home.js");
...
/***/ "./src/blocks/pages/home/components/banner/banner.js":
/*!***********************************************************!*\
  !*** ./src/blocks/pages/home/components/banner/banner.js ***!
  \***********************************************************/
/*! no static exports found */
...
documentReady(function () {
  var $btn = $(".banner__btn");
  var $btnFirstText = $btn.data("text-first");
  var $btnSecondText = $btn.data("text-second"); // -- Functions BEGIN

  var changeVideos = function changeVideos() {
    $btn.on("click", function () {
      ...
      $(".banner__video.".concat($(this).data("cur-video"))).addClass("active");
    });
  }; // -- Functions END
...
/***/ "./src/blocks/pages/home/components/components.js":
/*!********************************************************!*\
  !*** ./src/blocks/pages/home/components/components.js ***!
  \********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_pages_home_components_banner_banner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! %blocks%/pages/home/components/banner/banner */ "./src/blocks/pages/home/components/banner/banner.js");
/* harmony import */ var _blocks_pages_home_components_banner_banner__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_blocks_pages_home_components_banner_banner__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _blocks_pages_home_components_products_products__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %blocks%/pages/home/components/products/products */ "./src/blocks/pages/home/components/products/products.js");
/* harmony import */ var _blocks_pages_home_components_products_products__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_blocks_pages_home_components_products_products__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _blocks_pages_home_components_slider_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %blocks%/pages/home/components/slider/slider */ "./src/blocks/pages/home/components/slider/slider.js");
/* harmony import */ var _blocks_pages_home_components_light_light__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! %blocks%/pages/home/components/light/light */ "./src/blocks/pages/home/components/light/light.js");
/* harmony import */ var _blocks_pages_home_components_contacts_contacts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! %blocks%/pages/home/components/contacts/contacts */ "./src/blocks/pages/home/components/contacts/contacts.js");
/* harmony import */ var _blocks_pages_home_components_contacts_contacts__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_blocks_pages_home_components_contacts_contacts__WEBPACK_IMPORTED_MODULE_4__);
...
/***/ "./src/blocks/pages/home/components/contacts/contacts.js":
/*!***************************************************************!*\
  !*** ./src/blocks/pages/home/components/contacts/contacts.js ***!
  \***************************************************************/
/*! no static exports found */
...
documentReady(function () {
  var map = document.getElementById("map"); // -- Functions BEGIN
...
/***/ "./src/blocks/pages/home/components/light/light.js":
/*!*********************************************************!*\
  !*** ./src/blocks/pages/home/components/light/light.js ***!
  \*********************************************************/
/*! no exports provided */
...
documentReady(function () {
  var $btn = $(".light__btn");
  var $btnFirstText = $btn.data("text-first");
  var $btnSecondText = $btn.data("text-second");
  var $slider = $(".light__slider"); // -- Functions BEGIN
  ...
  var initEvent = function initEvent() {
    ...
    function initSlider() {
      initSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($slider, sliderOptions);
    }
...
/***/ "./src/blocks/pages/home/components/products/products.js":
/*!***************************************************************!*\
  !*** ./src/blocks/pages/home/components/products/products.js ***!
  \***************************************************************/
/*! no static exports found */
...
documentReady(function () {
  var $btn = $(".products__btn");
  var $btnFirstText = $btn.data("text-first");
  var $btnSecondText = $btn.data("text-second");
  var $products = $(".products .products__list-item");
  var windowW = $(window).width();
  var productCount = windowW > breakpoints.xl ? 4 : windowW > breakpoints.lg && windowW < breakpoints.xl ? 3 : windowW > breakpoints.md && windowW < breakpoints.lg ? 2 : 2; // -- Functions BEGIN

  var showFirstsItems = function showFirstsItems() {
    $products.each(function (count) {
      if (count < productCount) $(this).show();
    });
  };

  var initHideEvent = function initHideEvent() {
    showFirstsItems();
    $btn.on("click", function () {
      var curText = $(this).text();
...
/***/ "./src/blocks/pages/home/components/slider/slider.js":
/*!***********************************************************!*\
  !*** ./src/blocks/pages/home/components/slider/slider.js ***!
  \***********************************************************/
/*! no exports provided */
...
documentReady(function () {
  var $slider = $(".slider .swiper-container");
  var $btnPrev = $(".slider .slider__btn_prev");
  var $btnNext = $(".slider .slider__btn_next"); // -- Functions BEGIN
  ...
  var initSlider = function initSlider() {
    ...
    var initSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($slider, sliderOptions);
  }; // -- Functions END
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_pages_home_components_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! %blocks%/pages/home/components/components */ "./src/blocks/pages/home/components/components.js");
...
ready(function () {
  var $btnsShowPopups = $(".modal-btn");
  var $elementsHidePopups = $(".close-modal");
  var $allPopups = $(".popup");
  var $page = $("html, body");
  var $curPopup;
...
/* harmony import */ var _js_common_tabs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! %js%/common/tabs.js */ "./src/js/common/tabs.js");
/* harmony import */ var _js_common_tabs_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_common_tabs_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _js_common_scroll_to_block__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! %js%/common/scroll-to-block */ "./src/js/common/scroll-to-block.js");
/* harmony import */ var _js_common_scroll_to_block__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_common_scroll_to_block__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _js_common_cart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! %js%/common/cart */ "./src/js/common/cart.js");
/* harmony import */ var _js_common_cart__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_js_common_cart__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _js_common_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! %js%/common/form */ "./src/js/common/form.js");
/* harmony import */ var _js_common_form__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_js_common_form__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _blocks_blocks_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! %blocks%/blocks.js */ "./src/blocks/blocks.js");
...
documentReady(function () {
  ...
  var cart = new Vue({
    ...
    watch: {
      resultProducts: {
        handler: function handler(arr) {
          ...
          var cartCountEls = document.querySelectorAll(".cart__count");
    ...
    methods: {
      getProductFromStore: function getProductFromStore(id) {
        return productsStore.find(function (item) {
          return item.id === id;
        });
      },
      getReactiveProduct: function getReactiveProduct(id) {
        return this.resultProducts.find(function (item) {
          return item.id === id;
        });
      },
      ...
      addProduct: function addProduct(id) {
        var product = this.getProductFromStore(id);
      ...
      moreProduct: function moreProduct(id) {
        this.getReactiveProduct(id).count++;
      },
      lessProduct: function lessProduct(id) {
  ...
  var $productBtns = $(".products__list-item-cart");
  $productBtns.on("click", function (e) {
    e.preventDefault();
    var productId = $(this).closest(".products__list-item").data("id");
...
documentReady(function () {
  var images = $("span.replace-svg"); // -- Functions BEGIN
  ...
  var addEventButtons = function addEventButtons() {
    $btns.on("click", function (e) {
      ...
      if ($block.length) {
        ...
        var offsetTop = $(window).width() > 992 ? 30 : 0;
        $([document.documentElement, document.body]).animate({
          scrollTop: blockOffset - headerHeight + offsetTop
        }, 1000);
      }
    });
  }; // -- Functions END
  ...
  var initTabs = function initTabs() {
    $tabs.on("click", function () {
      if (!$(this).hasClass("tab_cur")) {
        ...
        $(this).closest(".block-tabs").find(".tab-btn, .tab-content").removeClass("tab-btn_cur tab-content_cur");
        $(this).addClass("tab-btn_cur").closest(".block-tabs").find("div[data-tab-key=".concat(key, "]")).addClass("tab-content_cur");
        var secClass = $(this).attr("data-sec-class");
        ...
        if (secClass) {
          ...
          sec.removeClass.apply(sec, secClasses);
        }
      }
    });
  };
